...
public class Java_interface_Test2 {
...
/*
 	...
 	!인터페이스!
 	1. 다중 구현
 		클래스가 여러개의 언터페이스를 연결하여 구현할 수 있다
 	
 	2. 유연성
 		클래스는 필요한 인터페이스를 조합하여 구현할 수 있다
 		
 	3. 약한 결합
 		클래스는 필요한 인터페이스만 구현하면 되므로 상속관계일 때 보다
