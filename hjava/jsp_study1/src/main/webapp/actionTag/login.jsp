<%@ page language="java" contentType="text/html; charset=UTF-8"
   ...
   <html lang="en" data-bs-theme="light"><head><script src="https://getbootstrap.kr/docs/5.3/assets/js/color-modes.js"></script>
...
<link href="https://getbootstrap.kr/docs/5.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-QWTKZyjpPEjISv5WaRU9OFeRpok6YctnYmDr5pNlyT2bRjXh0JMhjY6hW+ALEwIH" crossorigin="anonymous">
    ...
    <!-- Favicons -->
<link rel="apple-touch-icon" href="https://getbootstrap.kr/docs/5.3/assets/img/favicons/apple-touch-icon.png" sizes="180x180">
<link rel="icon" href="https://getbootstrap.kr/docs/5.3/assets/img/favicons/favicon-32x32.png" sizes="32x32" type="image/png">
<link rel="icon" href="https://getbootstrap.kr/docs/5.3/assets/img/favicons/favicon-16x16.png" sizes="16x16" type="image/png">
...
<link rel="icon" href="https://getbootstrap.kr/docs/5.3/assets/img/favicons/favicon.ico">
